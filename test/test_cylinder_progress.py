# -*- coding: utf-8 -*-
# @Time    : 2019/9/16 11:44
# @Author  : llc
# @File    : test_cylinder_progress.py.py
from PyQt5.QtCore import QTimer, Qt
from PyQt5.QtGui import QColor
from PyQt5.QtWidgets import QDialog, QPushButton, QSlider

from SomeWidgets import SCylinderProgress
...
class Window(QDialog):
    def __init__(self):
        ...
        self.scp1 = SCylinderProgress(color1=QColor(254, 154, 227), parent=self)
        self.scp1.move(100, 100)
        self.scp1.resize(300, 50)

        self.scp2 = SCylinderProgress(color1=QColor(174, 255, 126), parent=self)
        self.scp2.move(100, 200)
        self.scp2.resize(300, 50)

        self.scp3 = SCylinderProgress(color1=QColor(165, 217, 255), parent=self)
